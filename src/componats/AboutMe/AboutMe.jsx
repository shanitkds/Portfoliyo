  ...
  return (
    <>
      <div className='flex  bg-blue-500 h-dvh AboutMain '>
        <div className='mt-40 ml-30 ' data-aos="fade-up"><img src={ image } alt="" className='rounded-lg border-6 border-[#200353] w-[550px] sm:w-[850px] sm:h-[400px] about-img'/></div>
        <div className='mt-70 ml-30 sub-about' data-aos="fade-down">
